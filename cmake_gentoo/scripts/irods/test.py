...
def irods_directory():
    return os.path.normpath("/home/vanger/opt/irods/var/lib/irods")
#    return os.path.join(root_directory(), 'var', 'lib', 'irods')

def config_directory():
    return os.path.normpath("/home/vanger/opt/irods/etc")
#    return os.path.join(root_directory(), 'etc', 'irods')

def plugins_directory():
    return os.path.normpath("/home/vanger/opt/irods/lib64/irods/plugins")
...
print("irods_directory",irods_directory())
print("config_directory",config_directory())
print("plugins_directory",plugins_directory())
print("home_directory",home_directory())
print("core_re_directory",core_re_directory())
print("log_directory",log_directory())
print("irods_user_and_group_entries",irods_user_and_group_entries())