...
# this is bad, but scripts and source code use hard-coded "../.."
set( APPLICATION_NAME irods )
set( IRODS_HOME_DIR ${_inst_pref}var/lib/${APPLICATION_NAME} )
set( IRODS_HOME_DIRECTORY ${IRODS_HOME_DIR} )
set( IRODS_SBIN_DIR ${_inst_pref}usr/sbin )
set( IRODS_ETC_DIR ${_inst_pref}etc )
set( IRODS_INCLUDE_DIR ${_inst_pref}include/${APPLICATION_NAME} )
set( IRODS_LIBRARY_DIR ${_inst_pref}usr/lib${LIB_SUFFIX} )
...
set( IRODS_DOC_DIR ${_inst_pref}usr/share/doc/${APPLICATION_NAME} )
